...
export class Lights {
  ...
  clusterStorageBuffer: GPUBuffer;
  ...
  constructor(camera: Camera) {
    ...
    this.clusterBindGroup = device.createBindGroup({
      ...
      entries: [
        ...
        { binding: 2, resource: { buffer: this.clusterStorageBuffer } },
      ],
    });
  ...
  doLightClustering(encoder: GPUCommandEncoder) {
    ...
    computePass.dispatchWorkgroups(this.clusterX, this.clusterY, this.clusterZ);
    computePass.end();
  }
